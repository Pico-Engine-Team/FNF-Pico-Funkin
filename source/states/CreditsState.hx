...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		[
			["Pico Engine Team"],
			["LucasSanches",		"null",		"Main Programmer and Head of Pico Engine",					"https://github.com/Lucas62944/FNF-Pico-Enigne/tree/Master",	"F9393F"],
			[""],
			["Funkin' Crew"],
	...
	override function update(elapsed:Float)
	{
		...
		if(!quitting)
		{
			...
			if (controls.BACK)
			{
				...
				MusicBeatState.switchState(new lucas.states.funkin.scripts.menus.MainMenuState());
				quitting = true;
			}
		}
